...
CREATE TYPE "public"."job_listings_location_rqeuirement" AS ENUM('in-office', 'hybrid', 'remote');--> statement-breakpoint
...
CREATE TABLE "job_listings" (
	...
	"locationRequirement" "job_listings_location_rqeuirement" NOT NULL,
...
CREATE TABLE "organization_user_settings" (
	"userId" varchar NOT NULL,
	"organizationId" varchar NOT NULL,
	"newApplicationEmailNotifcations" boolean DEFAULT false NOT NULL,
